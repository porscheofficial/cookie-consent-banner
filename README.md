...
[![npm version](http://img.shields.io/npm/v/react-native-tableview-simple.svg?style=flat)](https://www.npmjs.com/package/porscheofficial/cookie-consent-banner)
...
[![npm](https://img.shields.io/npm/dm/react-native-tableview-simple.svg)](https://www.npmjs.com/package/porscheofficial/cookie-consent-banner)
...
## The Following is going to be removed before release

### Release

- Decouple version bump and npm release
- Run release locally to keep control

### TODO

- [x] Allow more properties
- [x] Setup own eslint
- [x] Discuss Props with legal
- [x] Release process
- [x] Cleanup Repo
- [x] README
- [ ] DEMO Page
- [x] Branch is main
- [x] Check if npm is allowed + unkpg or something (cdn)
- [x] Choose License
- [ ] Basic Contribution Guideline
- [x] Add basic tests (eslint)
- [ ] Replace badges
- [ ] Social Preview Image
- [x] README in published package
...
- https://cerovac.com/a11y/2020/07/cookie-consent-banners-and-overlays-thoughts-on-accessibility-usability-and-seo/
- https://techservicesillinois.github.io/accessibility/examples/notice/index.html

- Force Tab / Keyboard Focus?
